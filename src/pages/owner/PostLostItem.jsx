...
export default function PostLostItem() {
  ...
  async function submit(e) {
    ...
    try {
      ...
      setServerError(error.message || "Could not submit lost item.");
    }
  }
        ...
        <form className="card form" onSubmit={submit}>
          <div className="form-grid">
            <FormInput
              ...
              placeholder="e.g., KFUPM ID Card, Blue Backpack"
            />
          ...
          <FormInput
            ...
            placeholder="Include unique features, contents, serial numbers, marks, or stickers."
          />
          ...
          <div className="form-grid">
            ...
            <div className="field">
              <label>
                Image Upload <span className="muted">optional</span>
              </label>
              <input
                type="file"
          ...
          <div className="upload-preview">
            {preview ? (
              ...
              <span>Selected image preview will appear here</span>
            )}
          </div>
